...
public class SetGame implements Runnable{
  ...
  private static final String DUPLICATE_INPUT_WARNING_MESSAGE = "You have selected the same number."
  ...
  /**
   * Constructor for the SetGame class. it initializes deck, cards, set, and indexes.
   * Shuffles the deck and call divideCards method.
